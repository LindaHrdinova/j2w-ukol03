...
public class VizitkaController {
    private final List<Vizitka> seznamVizitek = List.of(
            ...
            new Vizitka("Melichar von Buchtičkov", "Buchtičkovi s. r. o.", "Na Kocourkách 6", "169 00", null, null, "www.buchtickovi.cz"),
            new Vizitka("princezna Polly", "Buchtičkovi s. r. o.", "Na Kocourkách 6", "169 00", null, null, "www.buchtickovi.cz")
    );
