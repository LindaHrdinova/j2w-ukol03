...
public class VizitkaController {
    private final List<Vizitka> seznamVizitek = List.of(
            ...
            new Vizitka("Linda Hrdinová", "Buchtičkovi s. r. o.", "Na Kocourkách 6", "169 00", "hrdinova.linda@seznam.cz", "+420 789 123 456", "www.buchtickovi.cz"),
            new Vizitka("Melichar von Buchtičkov", "Buchtičkovi s. r. o.", "Na Kocourkách 16/6", "169 00", null, null, "www.buchtickovi.cz"),
            new Vizitka("Princezna Polly", "Buchtičkovi s. r. o.", "Na Kocourkách 16/6", "169 00", null, null, "www.buchtickovi.cz")
    );
